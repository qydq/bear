...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_reset(JNIEnv *__unused  env, jclass  __unused class, jlong gifInfo) {
...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_setSpeedFactor(JNIEnv __unused *env, jclass __unused handleClass,
...
__unused JNIEXPORT void JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_seekToTime(JNIEnv *env, jclass __unused handleClass,
...
__unused JNIEXPORT void JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_seekToFrame(JNIEnv *env, jclass __unused handleClass,
...
__unused JNIEXPORT void JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_saveRemainder(JNIEnv *__unused  env, jclass __unused handleClass,
                                                      jlong gifInfo) {
	GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_restoreRemainder(JNIEnv *__unused env,
