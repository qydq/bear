...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_openFile(JNIEnv *env, jclass __unused class, jstring jfname) {
...
__unused JNIEXPORT jlong JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_openByteArray(JNIEnv *env, jclass __unused class, jbyteArray bytes) {
...
__unused JNIEXPORT jlong JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_openDirectByteBuffer(JNIEnv *env, jclass __unused class, jobject buffer) {
...
__unused JNIEXPORT jlong JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_openStream(JNIEnv *env, jclass __unused class, jobject stream) {
...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_extractNativeFileDescriptor(JNIEnv *env, jclass __unused handleClass, jobject fileDescriptor, jboolean closeOriginalDescriptor) {
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_createTempNativeFileDescriptor(JNIEnv __unused *env, jclass __unused handleClass) {
	return eventfd(0, 0);
}

__unused JNIEXPORT jlong JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_openNativeFileDescriptor(JNIEnv *env, jclass __unused handleClass, jint fd, jlong offset) {
