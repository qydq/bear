...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getComment(JNIEnv *env, jclass __unused handleClass, jlong gifInfo) {
...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_isAnimationCompleted(JNIEnv __unused *env, jclass __unused handleClass, jlong gifInfo) {
...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getLoopCount(JNIEnv __unused *env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info == NULL) {
		return 0;
	}
...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_setLoopCount(JNIEnv __unused *env, jclass __unused handleClass, jlong gifInfo, jchar loopCount) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info != NULL) {
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getDuration(JNIEnv *__unused  env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info == NULL) {
		return 0;
	}
...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getSourceLength(JNIEnv __unused *env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info == NULL) {
		return -1;
	}
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getCurrentPosition(JNIEnv *__unused env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info == NULL) {
		return 0;
	}
...
__unused JNIEXPORT jlong JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getMetadataByteCount(JNIEnv *__unused  env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info == NULL) {
		return 0;
	}
...
__unused JNIEXPORT jlong JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getAllocationByteCount(JNIEnv *__unused  env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info == NULL) {
		return 0;
	}
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getNativeErrorCode(JNIEnv *__unused  env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info == NULL) {
		return 0;
	}
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getCurrentLoop(JNIEnv __unused *env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info == NULL) {
		return 0;
	}
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getCurrentFrameIndex(JNIEnv __unused *env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info == NULL) {
		return -1;
	}
...
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getSavedState(JNIEnv *env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	if (info == NULL) {
		return NULL;
	}
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_restoreSavedState(JNIEnv *env, jclass __unused handleClass,
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getFrameDuration(__unused JNIEnv *env, jclass __unused handleClass, jlong gifInfo, jint index) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
	return info == NULL ? 0 : (jint) info->controlBlock[index].DelayTime;
}

__unused JNIEXPORT jboolean JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_isOpaque(__unused JNIEnv *env, jclass __unused handleClass, jlong gifInfo) {
	GifInfo *const info = ((GifInfo *) (intptr_t) gifInfo);
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getWidth(__unused JNIEnv *env, jclass __unused class, jlong gifInfo) {
	GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
	if (info == NULL) {
		return 0;
	}
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getHeight(__unused JNIEnv *env, jclass __unused class, jlong gifInfo) {
	GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
	if (info == NULL) {
		return 0;
	}
...
__unused JNIEXPORT jint JNICALL
Java_com_sunsta_bear_engine_gif_GifInfoHandle_getNumberOfFrames(__unused JNIEnv *env, jclass __unused class, jlong gifInfo) {
	GifInfo *info = (GifInfo *) (intptr_t) gifInfo;
	if (info == NULL) {
		return 0;
	}
