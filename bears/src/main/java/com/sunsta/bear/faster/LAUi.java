...
public class LAUi {
    ...
    private enum LaEnumUi {
        INSTANCE;
        private LAUi laInstance;

        LaEnumUi() {
            laInstance = new LAUi();
        }

        private LAUi getInstance() {
            return laInstance;
        }
    }
    ...
    public List<Icon> getIcons() {
        ...
        icons.add(new Icon(R.drawable.base_image_arrowback, R.drawable.base_image_arrowback, IconType.Heart));
        icons.add(new Icon(R.drawable.base_image_arrowback, R.drawable.base_image_arrowback, IconType.Star));
        icons.add(new Icon(R.drawable.base_image_clear_click, R.drawable.base_image_clear, IconType.Thumb));
        return icons;
    }
...
DiskCacheStrategy.ALL 缓存所有版本的图像（默认行为）*/
    ...
    public static void toolBarLayoutAnimation(View view) {
