...
public class NestProgressBar extends View {
    ...
    public NestProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                Shader.TileMode.MIRROR);
        ...
        paint.setColor(context.getResources().getColor(R.color.an_color_progressbar));//画笔设置颜色
