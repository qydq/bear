...
public class ImmersiveManage {
    ...
    public static void fitStatusBar(Activity activity, boolean lightMode, boolean fullScreen) {
        StatusBarUtils.fitStatusBar(activity, lightMode, fullScreen);
    }

    public static void fitNavigationBar(Activity activity, @IdRes int colorId) {
        StatusBarUtils.fitNavigationBar(activity, colorId);
    }
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                if (isMarginStatusBar && isMarginNavigationBar) {
                    ...
                    StatusBarUtils.setLightStatusBar(baseActivity, isMarginStatusBar
