...
import com.sunsta.bear.engine.picker.adapter.NumericWheelAdapter;
import com.sunsta.bear.engine.picker.listener.OnItemSelectedListener;
import com.sunsta.bear.engine.picker.widget.wheelview.INAWheelView;
...
public class WheelTime {
    ...
    private View view;
    private INAWheelView wv_year;
    private INAWheelView wv_month;
    private INAWheelView wv_day;
    private INAWheelView wv_hours;
    private INAWheelView wv_mins;
    ...
    public void setPicker(int year, int month, int day, int h, int m) {
        ...
        wv_year.setLabel(context.getString(R.string.an_year));// 添加文字
        wv_year.setCurrentItem(year - startYear);// 初始化时显示的数据

        // 月
        wv_month = view.findViewById(R.id.month);
        wv_month.setAdapter(new NumericWheelAdapter(1, 12));
        wv_month.setLabel(context.getString(R.string.an_month));
        ...
        wv_day.setLabel(context.getString(R.string.an_day));
        wv_day.setCurrentItem(day - 1);

        wv_hours = view.findViewById(R.id.hour);
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23));
        wv_hours.setLabel(context.getString(R.string.an_hours));// 添加文字
        wv_hours.setCurrentItem(h);

        wv_mins = view.findViewById(R.id.min);
        wv_mins.setAdapter(new NumericWheelAdapter(0, 59));
        wv_mins.setLabel(context.getString(R.string.an_minutes));// 添加文字
