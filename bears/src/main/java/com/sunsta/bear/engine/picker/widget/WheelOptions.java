...
import com.sunsta.bear.engine.picker.adapter.ArrayWheelAdapter;
...
public class WheelOptions<T> {
    ...
    private View view;
    private INAWheelView wv_option1;
    private INAWheelView wv_option2;
    private INAWheelView wv_option3;
    ...
    public void setPicker(ArrayList<T> options1Items,
        ...
        if (this.mOptions2Items == null)
            len = 12;
        // 选项1
        wv_option1 = (INAWheelView) view.findViewById(R.id.options1);
        wv_option1.setAdapter(new ArrayWheelAdapter(mOptions1Items, len));// 设置显示数据
        wv_option1.setCurrentItem(0);// 初始化时显示的数据
        // 选项2
        wv_option2 = (INAWheelView) view.findViewById(R.id.options2);
        ...
        // 选项3
        wv_option3 = (INAWheelView) view.findViewById(R.id.options3);
