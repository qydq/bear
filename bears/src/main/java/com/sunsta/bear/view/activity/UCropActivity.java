...
import com.sunsta.bear.faster.MimeType;
import com.sunsta.bear.faster.SelectedStateListDrawable;
import com.sunsta.bear.layout.ucrop.CropImageView;
import com.sunsta.bear.layout.ucrop.GestureCropImageView;
import com.sunsta.bear.layout.ucrop.OverlayView;
import com.sunsta.bear.layout.ucrop.TransformImageView;
import com.sunsta.bear.layout.ucrop.UCropView;
import com.sunsta.bear.layout.ucrop.widget.AspectRatioTextView;
import com.sunsta.bear.layout.ucrop.widget.HorizontalProgressWheelView;
...
public class UCropActivity extends AppCompatActivity {
    ...
    private boolean isOnTouch(Uri inputUri) {
        ...
        if (isHttp) {
            ...
            if (mimeType.endsWith("image/*")) {
                String path = FileUtils.INSTANCE.getPath(this, inputUri);
    ...
    protected void setupViews(@NonNull Intent intent) {
        ...
        mToolbarCancelDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CANCEL_DRAWABLE, R.drawable.in_ucrop_cross);
        mToolbarCropDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CROP_DRAWABLE, R.drawable.ic_ucrop_done);
        ...
        if (mShowBottomControls) {
            ...
            LayoutInflater.from(this).inflate(R.layout.item_ucrop_controls, wrapper, true);
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        for (AspectRatio aspectRatio : aspectRatioList) {
            wrapperAspectRatio = (FrameLayout) getLayoutInflater().inflate(R.layout.item_ucrop_aspect_ratio, null);
