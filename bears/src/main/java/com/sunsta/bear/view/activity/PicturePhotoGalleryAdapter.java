...
import com.sunsta.bear.callback.BitmapLoadCallback;
import com.sunsta.bear.model.CutInfo;
import com.sunsta.bear.model.ExifInfo;
import com.sunsta.bear.faster.BitmapLoadUtils;
import com.sunsta.bear.faster.MimeType;
import com.sunsta.bear.faster.SdkVersionUtils;
...
public class PicturePhotoGalleryAdapter extends RecyclerView.Adapter<PicturePhotoGalleryAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = mInflater.inflate(R.layout.item_ucrop_picturegf_edit_list,
                parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if (photoInfo.isCut()) {
            ...
            holder.iv_dot.setImageResource(R.drawable.in_ucrop_oval_true);
        } else {
        ...
        if (eqVideo) {
            ...
            Uri uri = SdkVersionUtils.checkedAndroid_Q() || MimeType.isHttp(path) ? Uri.parse(path) : Uri.fromFile(new File(path));
