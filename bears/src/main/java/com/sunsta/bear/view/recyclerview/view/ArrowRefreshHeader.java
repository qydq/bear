...
import com.sunsta.bear.view.recyclerview.recyclerview.ProgressStyle;
...
public class ArrowRefreshHeader extends LinearLayout implements IRefreshHeader {
    ...
    private View initIndicatorView(int style) {
        LoadingIndicatorView progressView = (LoadingIndicatorView) LayoutInflater.from(getContext()).inflate(R.layout.base_indicator_view, null);
    ...
    public void setIndicatorColor(int color) {
        if (mProgressBar.getChildAt(0) instanceof LoadingIndicatorView) {
            LoadingIndicatorView progressView = (LoadingIndicatorView) mProgressBar.getChildAt(0);
