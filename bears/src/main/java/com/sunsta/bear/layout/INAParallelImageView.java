...
import com.sunsta.bear.engine.IController;
import com.sunsta.bear.faster.LaLog;


/**
 * create with sunst 2018/06/09
 */
public class INAParallelImageView extends View {
    ...
    public INAParallelImageView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public INAParallelImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public void setController(IController controller) {
        LaLog.d("setController");
        ...
        mImageController.setProcessCallback(new ProcessCallback() {
            ...
            public void onProcessFinished(int width, int height) {
                LaLog.d("正常情况下只会走一次processListener:" + height);
                isScaled = true;
...
//                LogUtil.LOGE("onScrolled-----topDistance:" + topDistance);
    ...
    private void resetScaleFactor(int scaledHeight) {
        if (recyclerView != null) {
            ...
            LaLog.d("resetScaleFactor : " + scaleFactor);
        }
    }
