 ...
 * @version 1.0 |   2017/3/15           |   可以滑动的ListView
...
public class INASlidingMenuListView extends ListView {
    ...
    public INASlidingMenuListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray styled = getContext().obtainStyledAttributes(attrs, R.styleable.INASlidingMenuListView);

            mButtonID = styled.getResourceId(R.styleable.INASlidingMenuListView_anButtonID, -1);
            mEnableSliding = styled.getBoolean(R.styleable.INASlidingMenuListView_anEnableSliding, true);
        }
