...
/**
 * 圆形进度条控件
 * Author: sunst  qyddai@gmail.com
 * Time: 2019-08-07 15:38
 */
public class INACircleProgressBar extends View {
    ...
    public INACircleProgressBar(Context context) {
        this(context, null);
    }

    public INACircleProgressBar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public INACircleProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        @SuppressLint("Recycle")
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.INACircleProgressBar);
        // 初始化背景圆环画笔
        ...
        // 初始化进度
        mProgress = typedArray.getInteger(R.styleable.INACircleProgressBar_progress, 0);
        typedArray.recycle();
    }
