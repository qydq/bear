...
public class INACircleView extends View {
    ...
    public static final Property<INACircleView, Float> INNER_CIRCLE_RADIUS_PROGRESS = new Property<INACircleView, Float>(Float.class, "innerCircleRadiusProgress") {
        public Float get(INACircleView object) {
            return object.getInnerCircleRadiusProgress();
        }

        public void set(INACircleView object, Float value) {
            object.setInnerCircleRadiusProgress(value);
        }
    };
    public static final Property<INACircleView, Float> OUTER_CIRCLE_RADIUS_PROGRESS = new Property<INACircleView, Float>(Float.class, "outerCircleRadiusProgress") {
        public Float get(INACircleView object) {
    ...
    public INACircleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }

    public INACircleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void updateCircleColor() {
        float colorProgress = (float) DataService.getInstance().clamp((double) this.outerCircleRadiusProgress, 0.5D, 1.0D);
        colorProgress = (float) DataService.getInstance().mapValueFromRangeToRange((double) colorProgress, 0.5D, 1.0D, 0.0D, 1.0D);
