package com.sunsta.bear.view.multipleimage.adapter;
...
import com.sunsta.bear.view.multipleimage.model.Album;
...
public class CustomAlbumSelectAdapter extends CustomGenericAdapter<Album> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context)
                ...
                .placeholder(R.drawable.in_image_placeholder).centerCrop().into(viewHolder.imageView);
