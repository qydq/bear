...
import com.sunsta.bear.layout.PickerView;
 ...
 * <p>
 * 中文描述：时间选择器，後期會提供 同公用的SimpleSelector給大家使用 孫順濤
...
public class TimeSelector {
    ...
    public TimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate) {
        ...
        startCalendar.setTime(DataService.getInstance().parse(startDate, FORMAT_STR));
        endCalendar.setTime(DataService.getInstance().parse(endDate, FORMAT_STR));
        initDialog();
        initView();
    }
    ...
    private void initView() {
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                handler.handle(DataService.getInstance().format(selectedCalender.getTime(), FORMAT_STR));
                seletorDialog.dismiss();
            }
        });
