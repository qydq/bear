...
public class MultiCallback implements Callback {
	 ...
	 * {@link Callback#invalidateDrawable(Drawable)} of the target. For example if it is located inside {@link android.text.style.ImageSpan}
	 * displayed in {@link TextView}.
	 *
	 * @param useViewInvalidate whether {@link View#invalidate()} should be used instead of {@link Callback#invalidateDrawable(Drawable)}
	 */
