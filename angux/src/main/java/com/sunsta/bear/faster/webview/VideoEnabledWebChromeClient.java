...
public class VideoEnabledWebChromeClient extends WebChromeClient
     ...
     * This constructor allows this class to be defined as ali inline inner class in which the user can override methods
     */
    ...
    public void onShowCustomView(View view, CustomViewCallback callback) {
        if (view instanceof FrameLayout) {
            ...
            if (focusedChild instanceof android.widget.VideoView) {
                ...
                // JustNetSubscriber case: TextureView of Sony Xperia T API level 16 doesn't work fullscreen when loading the javascript below
                if (webView != null && webView.getSettings().getJavaScriptEnabled() && focusedChild instanceof SurfaceView) {
                    // Run javascript code that detects the video end and notifies the Javascript interface

                    LaLog.d("--qydq--","javascript");
