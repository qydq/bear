...
public class ThreadPool {
    ...
    //通用线程工作标志，默认true表示执行，false表示工作结束，当结束后需要保证该值为默认true
    public volatile static boolean FLAG_WORKING = true;
    ...
    private ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(@NonNull Runnable runnable) {
            return new Thread(runnable, "new_task#" + mCount.getAndIncrement());
        }
    };
