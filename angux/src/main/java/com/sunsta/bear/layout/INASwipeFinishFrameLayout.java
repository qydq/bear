 ...
 * <p>
 * 参考：xiaanming   http://blog.csdn.net/xiaanming
 * <p>
 * 中文描述：A custom ListView that if user sliding left a item of this ListView,
 ...
 * @version 1.0 |   2017/4/9          |   可以滑动的ListView
 * @link 知乎主页： https://zhihu.com/people/qydq
 */
public class INASwipeFinishFrameLayout extends FrameLayout {
    private static final String TAG = INASwipeFinishFrameLayout.class.getSimpleName();
    ...
    public INASwipeFinishFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public INASwipeFinishFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        mScroller = new Scroller(context);

//        mShadowDrawable = getResources().getDrawable(R.drawable.yy_drawable_slideclose_shadow);
        mShadowDrawable = ContextCompat.getDrawable(context, R.drawable.in_drawable_swipe_shadow);
