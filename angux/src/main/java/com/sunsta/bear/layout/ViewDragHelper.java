 ...
 * <p>
 * 中文描述：ViewDragHelper is a utility class for writing custom ViewGroups. It offers a
 ...
 * <h3>版权声明：(C) 2016 The Android Developer Sunst Inc.</h3>
 * <br>创建日期：2018/1/1
...
public class ViewDragHelper {
    ...
    public static abstract class Callback {
        ...
        /**
         * Called when the given edge may become locked. This can happen if ali
    ...
    /**
     * Return the size of ali edge. This is the range in pixels along the edges
     * of this view that will actively detect edge touches or drags if edge
     * tracking is enabled.
     * @return The size of ali edge in pixels
    ...
    /**
     * Set the size of ali edge. This is the range in pixels along the edges of
     * this view that will actively detect edge touches or drags if edge
     * tracking is enabled.
     * @param size The size of ali edge in pixels
     */
     ...
     * {@link #processTouchEvent(MotionEvent)} receiving ali
     * ACTION_CANCEL event.
     */
    public void cancel() {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                for (int i = 0; i < pointerCount; i++) {
                    ...
                    if (mDragState == STATE_DRAGGING) {
                        // Callback might have started ali edge drag
                        break;
                    }
     ...
     * @param edges Edges to check for ali initial edge touch. See
