 ...
 * <p>
 * 中文描述：SwipeMenuLayout
 * （可选）英文描述：SwipeMenuLayout
...
public class SwipeMenuLayout extends FrameLayout implements Controller {
    ...
    public SwipeMenuLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.INASwipeMenuLayout);
        mLeftViewId = typedArray.getResourceId(R.styleable.INASwipeMenuLayout_leftViewId, mLeftViewId);
        mContentViewId = typedArray.getResourceId(R.styleable.INASwipeMenuLayout_contentViewId, mContentViewId);
        mRightViewId = typedArray.getResourceId(R.styleable.INASwipeMenuLayout_rightViewId, mRightViewId);
        typedArray.recycle();
