...
public class INASlidingLayout extends FrameLayout {
    ...
    public INASlidingLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public INASlidingLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                    Log.e(LOG_TAG, "Got ACTION_MOVE event but don't have ali active pointer id.");
                    return false;
                }
